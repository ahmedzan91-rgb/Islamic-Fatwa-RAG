...
```bash
# تجربة سريعة أولاً للتأكد من تطابق الأعمدة
python run_pipeline.py --limit 2000

# البناء الكامل
python run_pipeline.py --chunk-size 900 --overlap 150
```
...
| **8** | `streamlit_app.py` | واجهة RTL | ٣ تبويبات · بناء الفهرس من الواجهة · مؤشرات جودة · تنزيل المصادر |
